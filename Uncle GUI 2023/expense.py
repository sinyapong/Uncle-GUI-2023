...
def insert_expense(title, price, dates):
    with conn:
        command = 'INSERT INTO expense VALUES (?,?,?,?)'
        c.execute(command, (None, title, price, dates))
    conn.commit()
    print('Saved')
...
icon_tab1 = PhotoImage(file='images/icon-tab1.png')
icon_tab2 = PhotoImage(file='images/icon-tab1.png')
...
# IMAGE
# icon = r'C:\\Users\\Uncle Engineer\\Desktop\\Python GUI 2023\\images\\expense.png'
icon = r'C:\Users\ying4\OneDrive\Desktop\Uncle GUI 2023\images\expense.png'
...
table.column('ค่าใช้จ่าย',anchor=CENTER)
